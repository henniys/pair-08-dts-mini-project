  ...
  return (
    <Layout ml="0px" mr="0px">
        ...
        >
          <div
            style={{
              ...
              height: "100%",
              background:
                "linear-gradient(19deg, rgba(0,0,0,1) 0%, rgba(28,28,192,0.03918662191439071) 50%)",
              display: "flex",
              alignItems: "center",
            }}
          >
            ...
            >
              {movieLogo && (
                <img
                  ...
                  src={`${process.env.REACT_APP_IMDB_IMAGE_URL}/${movieLogo}`}
                  alt=""
                />
              )}
              <div
      ...
      <Container sx={{ marginTop: 5 }}>
        ...
        >
          <Typography mr={2} fontSize={36} fontWeight="bold">
            {movie?.title}
          </Typography>
          <Typography
            sx={{
          ...
          >
            <Star sx={{ marginRight: "5px", color: "gold" }} />{" "}
